...
namespace BscTokenSniper.Models
{
    public class SniperConfiguration
    {
        ...
        public string V2PancakeswapRouterAddress { get; set; }
        public string V2PancakeswapFactoryAddress { get; set; }
        public string V3PancakeswapRouterAddress { get; set; }
        public string V3PancakeswapFactoryAddress { get; set; }
        ...
        public bool HoneypotDotIsCheckEnabled { get; set; }

...
namespace BscTokenSniper.Handlers
{
    public class TradeHandler : IDisposable
    {
        ...
        public TradeHandler(IOptions<SniperConfiguration> options, RugHandler rugChecker)
        {
            ...
            _pancakeContract = _bscWeb3.Eth.GetContract(File.ReadAllText("./Abis/PancakeRouterV2.json"), _sniperConfig.V2PancakeswapRouterAddress);
        ...
        //         var amount = await balanceFunction.CallAsync<BigInteger>(address);
        //         var bnbAmount = Web3.Convert.FromWei(
        //             BigInteger.Parse(tx.value)
        //         );
        ...
        public async Task<bool> Approve(string tokenAddress)
        {
            try
            {
                ...
                {
                    Spender = _sniperConfig.V2PancakeswapRouterAddress,
                    Value = Max
